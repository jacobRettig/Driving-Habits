...
def test_practical_without_readtime():
    ...
    print("practical without read time:")
...
def custom_speed_test():
    ...
    for _ in range(100):
        ...
        t2 = time.time()
        t_all += t2 - t1
    print('Average latency (ms): {:.2f}'.format(t_all * 1000 / 100))
    print('Average FPS: {:.2f}'.format(100 / t_all))



if __name__ == "__main__":
    ###captrue data from camera or video
    cap = cv2.VideoCapture("custum_test.avi") #uncommen to activate a video input
